    ...
    <div class="login-container">
        ...
        <div class="login-hero">
            <div class="hero-content">
                ...
                <p class="hero-subtitle">Continue your learning journey and unlock new skills with expert instructors.</p>
                ...
                <ul class="hero-benefits">
                    ...
                    <li>
                        ...
                        <span>Access all your saved courses</span>
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
                        </svg>
                        <span>Earn & showcase certificates</span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <form class="w-100">
                ...
                <div class="form-group-custom">
                    <div class="form-outline">
                        ...
                        <span id="email-error" class="text-danger d-none">Invalid email format.</span>
                    </div>
                </div>
                ...
                <div class="form-group-custom">
                    <div class="form-outline position-relative">
                        ...
                        <span id="password-error" class="text-danger d-none">Password is required.</span>
                    </div>
                </div>

                <a href="resetpassword.php" class="forgot-password">Forgot password?</a>

                <button type="button" id="signup" class="btn-login">Sign In</button>
