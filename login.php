...
<body style="display:none;height:100vh;align-items:center;" id="body-contain">
    <div class="container">
        <form class="border rounded-0 col-12 col-sm-8 col-md-6  col-xl-5 mx-auto" style="padding:30px 30px">
            ...
            <h4 class="text-center mb-4">Sign in to TrainMastas</h4>
            ...
            <div class="mt-3 mx-auto">
                ...
                <button id="signup" class="btn btn-success fw-semibold rounded-0" style="width:100%;font-size:14px; padding:4.5px">Login</button>

                <div class="mb-0 text-muted mt-2">Don't have an account? </div>
                <a href="signup.php" id="otherLink" class="btn btn-outline-success rounded-0 mt-3 fw-semibold" style="width:100%;font-size:14px; padding:4.5px">Create account</a>
            </div>
        </form>
    </div>
    <script>
