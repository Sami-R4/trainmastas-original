...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 11 déc. 2025 à 13:00
...
--
-- Structure de la table `admin_deleted`
--
...
--
-- Structure de la table `courses_rejected`
--
...
--
-- Structure de la table `course_feedback`
--
...
--
-- Structure de la table `course_payment`
--
...
--
-- Déchargement des données de la table `course_payment`
--
...
--
-- Structure de la table `course_registered`
--
...
--
-- Déchargement des données de la table `course_registered`
--
...
--
-- Structure de la table `course_scope`
--
...
--
-- Déchargement des données de la table `course_scope`
--
...
--
-- Structure de la table `course_score`
--
...
--
-- Déchargement des données de la table `course_score`
--
...
--
-- Structure de la table `course_test`
--
...
--
-- Déchargement des données de la table `course_test`
--
...
--
-- Structure de la table `teachers_rejected`
--
...
--
-- Déchargement des données de la table `teachers_rejected`
--
...
--
-- Structure de la table `teacher_extra`
--
...
--
-- Structure de la table `user_deleted`
--
...
--
-- Structure de la table `user_link`
--
...
--
-- Déchargement des données de la table `user_link`
--
...
--
-- Structure de la table `withdrew_payment`
--
...
--
-- Déchargement des données de la table `withdrew_payment`
--
...
--
-- Index pour la table `admin_deleted`
--
...
--
-- Index pour la table `courses_rejected`
--
ALTER TABLE `courses_rejected`
  ADD PRIMARY KEY (`course_ID`);

--
-- Index pour la table `course_feedback`
--
...
--
-- Index pour la table `teachers_rejected`
--
ALTER TABLE `teachers_rejected`
  ADD PRIMARY KEY (`user_ID`);

--
-- Index pour la table `teacher_extra`
--
...
--
-- Index pour la table `user_deleted`
--
ALTER TABLE `user_deleted`
  ADD PRIMARY KEY (`user_ID`);

--
-- Index pour la table `user_link`
--
...
--
-- Index pour la table `withdrew_payment`
--
