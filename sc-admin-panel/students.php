...
<head>
    ...
    <title id="page-title">Students Management - TrainMastas</title>
</head>
...
<body id="body-pd">
    ...
    <div class="height-100 pt-3">
        ...
        <div class="text-muted mb-3" style="font-size:13px"><span id="student-btn" class="border  rounded bg-light p-2" style="cursor:pointer">Students</span> <span class="fw-bold profile-btn d-none">></span> <span id="profile-btn" class="border rounded bg-light p-2 profile-btn d-none" style="cursor:pointer">Profile</span></div>
        <div id="user-container">
            ...
            <div style=" width: 100%; overflow: auto;" id="UserDiv">
                ...
                <div id="message-empty" class="text-muted d-none">No student was found!</div>
                                ...
                                <div class="d-flex d-column">
                                    <div class="m-auto text-center p-4">
                                        ...
                                        <div class="text-center mt-3">
                                            ...
                                            <a href="#" class="text-success d-none" style="text-decoration:none" target="_blank" id="portfolioLink">
